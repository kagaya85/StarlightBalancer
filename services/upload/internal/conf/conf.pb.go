...
type Bootstrap struct {
	...
	Balancer *Balancer `protobuf:"bytes,3,opt,name=balancer,proto3" json:"balancer,omitempty"`
}
...
func (x *Bootstrap) GetBalancer() *Balancer {
	if x != nil {
		return x.Balancer
	}
	return nil
...
type Server struct {
	...
	Prometheus *Server_Prometheus `protobuf:"bytes,2,opt,name=prometheus,proto3" json:"prometheus,omitempty"`
}
...
type Balancer struct {
	...
	MaxRetry int64  `protobuf:"varint,2,opt,name=maxRetry,proto3" json:"maxRetry,omitempty"`
}

func (x *Balancer) Reset() {
	*x = Balancer{}
	if protoimpl.UnsafeEnabled {
...
func (x *Balancer) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Balancer.ProtoReflect.Descriptor instead.
func (*Balancer) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3}
}

func (x *Balancer) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *Balancer) GetMaxRetry() int64 {
	if x != nil {
		return x.MaxRetry
	}
	return 0
...
func (x *Server_Prometheus) GetPort() string {
	if x != nil {
		return x.Port
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x08, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x14, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x42, 0x61, 0x6c,
	0x61, 0x6e, 0x63, 0x65, 0x72, 0x52, 0x08, 0x62, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x72, 0x22,
	0x81, 0x02, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x2b, 0x0a, 0x04, 0x67, 0x72,
	...
	0x43, 0x52, 0x04, 0x67, 0x72, 0x70, 0x63, 0x12, 0x3d, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x6d, 0x65,
	0x74, 0x68, 0x65, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6b, 0x72,
	...
	0x65, 0x74, 0x68, 0x65, 0x75, 0x73, 0x1a, 0x69, 0x0a, 0x04, 0x47, 0x52, 0x50, 0x43, 0x12, 0x18,
	...
	0x74, 0x1a, 0x20, 0x0a, 0x0a, 0x50, 0x72, 0x6f, 0x6d, 0x65, 0x74, 0x68, 0x65, 0x75, 0x73, 0x12,
	0x12, 0x0a, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70,
	0x6f, 0x72, 0x74, 0x22, 0x79, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0x3a,
	0x0a, 0x08, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x61, 0x64,
	0x64, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x61, 0x64, 0x64, 0x72, 0x12, 0x1a,
	0x0a, 0x08, 0x6d, 0x61, 0x78, 0x52, 0x65, 0x74, 0x72, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x08, 0x6d, 0x61, 0x78, 0x52, 0x65, 0x74, 0x72, 0x79, 0x42, 0x2e, 0x5a, 0x2c, 0x73, 0x74,
	0x61, 0x72, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73,
	0x2f, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Balancer)(nil),          // 3: kratos.api.Balancer
	(*Server_GRPC)(nil),       // 4: kratos.api.Server.GRPC
	(*Server_Prometheus)(nil), // 5: kratos.api.Server.Prometheus
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	3, // 2: kratos.api.Bootstrap.balancer:type_name -> kratos.api.Balancer
	4, // 3: kratos.api.Server.grpc:type_name -> kratos.api.Server.GRPC
	5, // 4: kratos.api.Server.prometheus:type_name -> kratos.api.Server.Prometheus
