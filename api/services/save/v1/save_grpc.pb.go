...
func (c *saveServiceClient) Save(ctx context.Context, in *SaveRequest, opts ...grpc.CallOption) (*SaveResponse, error) {
	out := new(SaveResponse)
	err := c.cc.Invoke(ctx, "/save.v1.SaveService/Save", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSaveServiceServer) Save(context.Context, *SaveRequest) (*SaveResponse, error) {
...
func _SaveService_Save_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/save.v1.SaveService/Save",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SaveServiceServer).Save(ctx, req.(*SaveRequest))
	}
...
var SaveService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "services/save/v1/save.proto",
}
