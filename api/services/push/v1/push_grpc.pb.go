...
type PushServiceClient interface {
	PushVideo(ctx context.Context, in *PushRequest, opts ...grpc.CallOption) (*PushResponse, error)
}
...
func (c *pushServiceClient) PushVideo(ctx context.Context, in *PushRequest, opts ...grpc.CallOption) (*PushResponse, error) {
	out := new(PushResponse)
	err := c.cc.Invoke(ctx, "/push.v1.PushService/PushVideo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PushServiceServer interface {
	PushVideo(context.Context, *PushRequest) (*PushResponse, error)
...
func (UnimplementedPushServiceServer) PushVideo(context.Context, *PushRequest) (*PushResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PushVideo not implemented")
}
...
func _PushService_PushVideo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PushRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PushServiceServer).PushVideo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/push.v1.PushService/PushVideo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PushServiceServer).PushVideo(ctx, req.(*PushRequest))
	}
...
var PushService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PushVideo",
			Handler:    _PushService_PushVideo_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "services/push/v1/push.proto",
}
